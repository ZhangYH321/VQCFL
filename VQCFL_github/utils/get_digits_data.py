...
def process_mnist():
    ...
    (14000,)
    """
    mnist_train = base_path+'\data\MNIST\\training.pt'
    mnist_test = base_path+'\data\MNIST\\test.pt'
    ...
    with open(base_path+'/data/MNIST/train.pkl', 'wb') as f:
        pkl.dump(train_stratified, f, pkl.HIGHEST_PROTOCOL)

    with open(base_path+'/data/MNIST/test.pkl', 'wb') as f:
...
def process_fmnist():
    ...
    train_img = Fashion_train.data.numpy()
    train_tar = Fashion_train.targets.numpy()
    test_img = Fashion_test.data.numpy()
    test_tar = Fashion_test.targets.numpy()
    ...
    with open(base_path+'/data/FMNIST/train.pkl', 'wb') as f:
        pkl.dump(train_stratified, f, pkl.HIGHEST_PROTOCOL)

    with open(base_path+'/data/FMNIST/test.pkl', 'wb') as f:
        pkl.dump(test_stratified, f, pkl.HIGHEST_PROTOCOL)
...
def process_svhn():
    ...
    (19858,)
    """
    train = scio.loadmat(base_path+'/data/SVHN/train_32x32.mat')
    test = scio.loadmat(base_path+'/data/SVHN/test_32x32.mat')
    ...
    with open(base_path+'/data/SVHN/train.pkl', 'wb') as f:
        pkl.dump(train_stratified, f, pkl.HIGHEST_PROTOCOL)

    with open(base_path+'/data/SVHN/test.pkl', 'wb') as f:
        pkl.dump(test_stratified, f, pkl.HIGHEST_PROTOCOL)
...
def process_usps():
    ...
    """
    import bz2
    train_path = base_path+'/data/USPS/usps.bz2'
    ...
    test_path = base_path+'/data/USPS/usps.t.bz2'
    ...
    with open(base_path+'/data/USPS/train.pkl', 'wb') as f:
        pkl.dump(train_stratified, f, pkl.HIGHEST_PROTOCOL)

    with open(base_path+'/data/USPS/test.pkl', 'wb') as f:
        pkl.dump(test_stratified, f, pkl.HIGHEST_PROTOCOL)
...
def process_synth():
    ...
    (97791,)
    """
    train = scio.loadmat(base_path+'/data/SynthDigits/synth_train_32x32.mat')
    test = scio.loadmat(base_path+'/data/SynthDigits/synth_test_32x32.mat')
    ...
    with open(base_path+'/data/SynthDigits/train.pkl', 'wb') as f:
        pkl.dump(train_stratified, f, pkl.HIGHEST_PROTOCOL)

    with open(base_path+'/data/SynthDigits/test.pkl', 'wb') as f:
        pkl.dump(test_stratified, f, pkl.HIGHEST_PROTOCOL)
...
def process_mnistm():
    ...
    :return:
    """
    data = np.load(base_path+'/data/MNIST_M/mnistm_data.pkl', allow_pickle=True)
    ...
    with open(base_path+'/data/MNIST_M/train.pkl', 'wb') as f:
        pkl.dump(train_stratified, f, pkl.HIGHEST_PROTOCOL)

    with open(base_path+'/data/MNIST_M/test.pkl', 'wb') as f:
        pkl.dump(test_stratified, f, pkl.HIGHEST_PROTOCOL)
...
if __name__ == '__main__':
    ...
    destination = base_path+r'\data\raw_data.zip'
